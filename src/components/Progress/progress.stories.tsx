    ...
    <div className="container">
      <div className="item">
        <Card title="基础使用" style={cardCss} shadow>
          <Progress percent={60} showText={false} style={commonCss} max={100} />
          <Progress percent={50} showText={false} style={commonCss} max={100} />
          <div style={commonCssText}>
            设置
            <code> animation</code> 为<code> true </code>
            时，将会显示动画效果，仅当 <code>type = line</code> 时生效
          </div>
          <Progress percent={70} style={commonCss} showText={false} animation max={100} />

          <Progress percent={90} style={commonCss} showText={false} animation max={100} />
          <div style={commonCssText}>
            <code>展示进度值描述：</code>
          </div>
          <Progress percent={50} style={commonCss} max={100} />
          <Progress percent={88} showText style={commonCss} max={100} />
        </Card>
      </div>
      <div className="item">
        <Card title="不同主题" style={cardCss} shadow>
          <div style={{ marginBottom: 20, fontSize: 14 }}>
            一共支持七种主题：
            <code>primary 、 secondary 、 success 、 warning 、 danger 、 info 、 dark</code>
          </div>
          <Progress percent={40} style={commonCss} showText={false} max={100} />
          <Progress percent={30} style={commonCss} showText={false} max={100} />
        </Card>
      </div>
      <div className="item">
        <Card title="圆形进度条" style={{ margin: '20px 20px 0 0', width: 420 }} shadow>
          <div style={commonCssText}>
      ...
      <div className="item">
        <Card title="动态演示" style={cardCss} shadow>
          <Progress percent={count} style={commonCss} max={100} />
          <Button onClick={() => setCount(count - 1 <= 0 ? 0 : count - 1)}>完成度 - 1</Button>
          <Button
            style={{ marginLeft: 20 }}
          ...
          <Progress
            ...
            showText
          />
          <Button onClick={() => setCount2(count2 - 5 <= 0 ? 0 : count2 - 5)}>完成度 - 5</Button>
          <Button
            style={{ marginLeft: 20 }}
      ...
      <div className="item">
        <Card title="设置粗细" style={cardCss} shadow>
          ...
          <Progress percent={30} strokeHeight={10} style={commonCss} max={100} />
        </Card>
      </div>
      <div className="item">
